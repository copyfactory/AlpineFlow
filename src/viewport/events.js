...
import {isMacOs, isRightClickPan, isWrappedWithClass, transformToViewport, viewChanged, wheelDelta} from './utils';
...
export function createZoomOnScrollHandler({ noWheelClassName, preventScrolling, d3ZoomHandler }) {
...
export function createPanZoomStartHandler({ zoomPanValues, onDraggingChange, onPanZoomStart }) {
  return (event) => {
